  ...
  const slides = [
    {
      ...
      subtitle:
        "Descubra as últimas aventuras dos seus heróis favoritos",
      link: "#marvel",
      publisher: "Marvel",
    },
    {
      ...
      subtitle:
        "Explore as histórias épicas da Liga da Justiça",
      link: "#dc",
      publisher: "DC",
    },
    {
      ...
      subtitle:
        "Coleções raras e limitadas disponíveis agora",
      link: "#especiais",
      publisher: "Special",
    },
    {
      ...
      subtitle:
        "Marvel vs DC - As maiores batalhas já contadas",
      link: "#crossover",
      publisher: "Both",
    },
  ];
              ...
              <div className={styles.content}>
                <div className={styles.contentInner}>
                  {slide.publisher === "Marvel" && (
                    <div className={styles.badgeMarvel}>
                      MARVEL
                    </div>
                  )}

                  {slide.publisher === "DC" && (
                    <div className={styles.badgeDc}>
                      DC COMICS
                    </div>
                  )}

                  {slide.publisher === "Both" && (
                    <div className={styles.badgeBoth}>
                      MARVEL & DC
                    </div>
                  )}

                  {slide.publisher === "Special" && (
                    <div className={styles.badgeSpecial}>
                      ESPECIAL
                    </div>
                  )}
